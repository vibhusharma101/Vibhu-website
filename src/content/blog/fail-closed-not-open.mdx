...
excerpt: "The most dangerous security bug isn't a missing control — it's a control that silently does nothing when misconfigured. Four real before/after examples of designing things to break loudly and safely instead of quietly and dangerously."
date: "2026-07-09"
readTime: "7 min read"
...
Here are four patterns, each a real before/after. Toggle between the dangerous and safe versions:
...
## 2. The Fail-Open Bug I Caught in Review
