...
excerpt: "Part 1 of 5 — The first version of PRS at Powerplay was three sequential LLM passes over a diff. It shipped, it caught real bugs, and it had two problems at once: about one in five comments was noise, and it stayed silent on the bugs that mattered most. Both had the same root cause."
date: "2026-07-28"
readTime: "9 min read"
...
## Problem one: about one in five comments was noise
...
**81.2% useful.** That sounds decent, and it isn't, because a reviewer isn't judged on its average — it's judged on its worst comment. One confident-but-wrong *"this field doesn't exist"* costs more trust than ten good comments earn, because now the engineer has to verify everything the bot says. Which is exactly the work it was supposed to save.

The percentage wasn't the valuable part anyway. Grading 350 comments by hand forced me to categorise *why* the bad ones were bad, and four patterns fell out.
...
Here's the thing the 81.2% could never have told me, and the reason I distrust precision metrics on their own now.

**A precision audit only grades the comments the reviewer actually wrote.** It is structurally blind to the ones it should have written and didn't. I could have driven that number to 95% by making the bot more timid, and shipped a strictly worse tool.
...
One last thing the audit gave me, which mattered more than the 81.2%: **the habit of scoring the reviewer on a schedule.** Every improvement in this series was chosen because a measurement demanded it. That discipline is the actual product. The code is downstream of it.
