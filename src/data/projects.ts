...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'A repo-native CLI that estimates task complexity from multiple signals and routes to a Haiku → Sonnet → Opus → Fable capability ladder — with risk floors for security/production work, a confidence-gated escalation cascade, and parallel-agent recommendations for multi-agent work. Ships with git-level guardrails: secrets scanning, branch protection, and scoped post-hooks.',
    stack: ['TypeScript', 'Node.js', 'Claude API', 'CLI'],
    liveUrl: 'https://vibhusharma101.github.io/codemux/',
    githubUrl: 'https://github.com/vibhusharma101/codemux',
    featured: true,
